...
ependFile <- file.path(resultsDir, "fusion_summary_ependymoma_foi_new.tsv")
embryFile <- file.path(resultsDir, "fusion_summary_embryonal_foi_new.tsv")
ewingsFile <- file.path(resultsDir, "fusion_summary_ewings_foi_new.tsv")
lgg_hggFile <- file.path(resultsDir, "fusion_summary_lgg_hgg_foi_new.tsv")
```
